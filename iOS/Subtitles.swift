...
//                }
    ...
    fileprivate func addSubtitleLabel() {
        ...
        guard let _ = subtitleLabel else {
            ...
            //subtitleLabel?.semanticContentAttribute = .forceRightToLeft
            contentOverlayView?.addSubview(subtitleLabel!)
            
            // Position
            subtitleLabel?.centerXAnchor.constraint(equalTo: contentOverlayView!.centerXAnchor).isActive = true
            subtitleLabel?.widthAnchor.constraint(equalTo: contentOverlayView!.widthAnchor, multiplier: 0.8).isActive = true
            subtitleLabel?.bottomAnchor.constraint(equalTo: contentOverlayView!.safeAreaLayoutGuide.bottomAnchor, constant: -30).isActive = true
